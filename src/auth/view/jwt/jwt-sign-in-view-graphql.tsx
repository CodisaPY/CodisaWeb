...
import { loginWithGraphQL, searchUserWithGraphQL, changePasswordWithGraphQL } from '../../context/jwt/graphql-auth';
import { JwtOTPView } from './jwt-otp-view';
...
export function JwtSignInViewGraphQL() {
  ...
  const onSubmit = handleSubmit(async (data) => {
    ...
    try {
      await loginWithGraphQL(data.email, data.password);
