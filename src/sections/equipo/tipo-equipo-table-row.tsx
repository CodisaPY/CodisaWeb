...
export function TipoEquipoTableRow({ row, onEditRow, onDeleteRow, dense }: Props) {
  ...
  return (
    <>
      ...
      <ConfirmDialog
        ...
        content={`¿Estás seguro que deseas eliminar el tipo de equipo "${row.nombre}"?`}
        action={
